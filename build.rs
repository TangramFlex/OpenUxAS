...
fn main() {
    ...
    link_dep(&meson_build, "/3rd/zeromq-4.1.6", "zeromq");
    link_dep(&meson_build, "/3rd/zyre-1.1.0", "zyre");
    link_dep(&meson_build, "/3rd/czmq-3.0.1", "czmq");
    link_dep(&meson_build, "/3rd/cppzmq-4.2.1", "cppzmq");
