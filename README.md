...
NOTE: As with the software build instructions, we retain this section for reference. The steps listed here *should be* performed by the `build_documentation.sh` script described above. References in this section may be outdated or incorrect.
...
Note that instructions in this section *should be* automated by the `install_prerequisites.sh` script described above. This section is retained primarily for reference. Some of the references may be outdated or incorrect.
...
_NOTE: The following is likely outdated. See the script._
